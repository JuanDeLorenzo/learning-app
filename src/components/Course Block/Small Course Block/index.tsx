...
const Block = ({variant, picture=image, course="course", notifications=0,...rest}:BlockProps) => {
    return <button className={blockVariant({variant})} {...rest}>
        ...
        {(notifications > 0)?
        <div className="w-[24.07px] h-[24.07px] text-center items-center justify-center absolute bg-red-600 rounded-full text-lg font-normal font-['League Spartan'] -mr-44 mt-16 group-hover:bg-red-800">
